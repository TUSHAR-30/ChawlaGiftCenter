...
const defaultCategoryLayoutClass = "col-span-1 row-span-1 md:col-span-1 md:row-span-1 xl:col-span-1 xl:row-span-1";
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="bento-grid">
          {categories.map((category, index) => (
            <div
              key={category.title}
              className={`joy-shadow hover-lift group relative cursor-pointer overflow-hidden rounded-3xl border-4 border-white shadow-lg ${categoryLayoutClasses[index] ?? defaultCategoryLayoutClass}`}
            >
              <img
                alt={category.alt}
