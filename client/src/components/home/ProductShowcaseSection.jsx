...
const showcaseItems = [
  {
    ...
    backgroundSrc: "/category1/env/background.jfif",
    leftImageSrc: "/category1/image1.avif",
    rightImageSrc: "/category1/image2.jfif",
  },
  {
    id: "category2",
    title: "Avengers Products",
    modelSrc: "/category2/model.glb",
    backgroundSrc: "/category2/env/background.jfif",
